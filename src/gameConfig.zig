...
pub const GameConfig = struct {
    ...
    pub fn init(
        ...
        return .{
            ...
            .reactorTextureAtlas = reactorTextureAtlas,
    ...
    pub fn setPlayerTexture(self: *@This(), player1Texture: rl.Texture, player2Texture: rl.Texture) void {
        self.player1Texture = player1Texture;
        self.player2Texture = player2Texture;
    }
};
